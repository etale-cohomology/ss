...
#define MAX_COMPRESSION_RATIO (16)  // If the data doesn't have decompressed size with it, fallback on assuming the compression ratio is at most 16
#define MAX_OUTPUT_SIZE ((size_t)1024 * 1024 * 1024)  // Protect against allocating too much memory for output
