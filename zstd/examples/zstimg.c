...
t gcc-8  zstimg.c -o zstimg  -lpthread -lxcb -lxcb-shm  -I../lib        ../lib/libzstd.a  $cfast  &&  t ./zstimg
t gcc-8  zstimg.c -o zstimg  -lpthread -lxcb -lxcb-shm  -I../lib $git/zstd/lib/libzstd.a  $cfast  &&  t ./zstimg
t gcc-8  zstimg.c -o zstimg  -lpthread -lxcb -lxcb-shm  -I../lib            -l:libzstd.a  $cfast  &&  t ./zstimg
